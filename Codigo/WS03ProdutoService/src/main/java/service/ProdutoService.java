...
public class ProdutoService {
	...
	/*public Object insert(Request request, Response response) {
	    ...
	    maxId = Integer.parseInt(request.queryParams("id"));
		...
		Produto produto = new Produto(maxId, descricao, preco, quantidade, dataFabricacao, dataValidade);
	...
	public Object insert(Request request, Response response) {
		...
		Produto produto = new Produto(dao.getMaxId() + 1, descricao, preco, quantidade, dataFabricacao, dataValidade);
