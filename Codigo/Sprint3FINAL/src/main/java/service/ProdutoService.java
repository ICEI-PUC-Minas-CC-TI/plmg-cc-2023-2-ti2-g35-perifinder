	...
	public void makeForm(int tipo, Produto produto, int orderBy) {
		...
		for (Produto p : produtos) {
			...
			list += "\n<tr bgcolor=\""+ bgcolor +"\">\n" + 
            		  ...
            		  "\t<td align=\"center\" valign=\"middle\"><a href=\"javascript:confirmarDeleteProduto('" + p.getID() + "', '" + p.getNome() + "', '" + p.getCategoria() + "');\"><img src=\"/image/delete.png\" width=\"20\" height=\"20\"/></a></td>\n" +
            		  "</tr>\n";
		}
		list += "</table>";		
